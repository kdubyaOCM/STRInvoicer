...
2. **Excel Date Handling**: When uploading files with date columns, the app automatically detects and converts:
   ...
   - The conversion formula calculates milliseconds since Unix epoch: `milliseconds = (Excel_Serial - 25569) * 86400 * 1000`. The value 25569 represents the offset in days between Excel's epoch (January 1, 1900) and Unix epoch (January 1, 1970). The value 86400 is the number of seconds per day.
